    ...
    def average_transaction(self, customer_id):
        ...
        for customer in self.saledata:
            ...
            if cus == customer_id:
                nbr += 1
                avr += amo
        return avr/nbr if nbr > 0 else None
...
# Get the average transaction for a customer
print(sales_data.average_transaction(1))  # Output: 250.25